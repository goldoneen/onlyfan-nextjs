...
export default function FreeModesPage() {
  ...
  return (
    <section className="pb-12 bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9] min-h-screen">
      <div className="bg-white py-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8 text-center">OnlyFans Models in Free Models</h1>
        <h1 className="text-xl font-medium mb-8 text-center">Discover OnlyFans creators near you in Free Models</h1>
      </div>
      ...
      <div className="container mx-auto">
        {loading ? (
          ...
          <div className="text-center text-lg text-gray-500 py-8">No free models found.</div>
        )}
      </div>
    </section>
  );
